...
public class CTW extends JavaPlugin implements PluginMessageListener {
    ...
    public void onEnable() {
        ...
        CTW.em = new EffectManager((Plugin) this);
        ...
        this.getCommand("join").setExecutor((CommandExecutor) joinCmd);
        this.getCommand("g").setExecutor((CommandExecutor) gChat);
        this.getCommand("leave").setExecutor((CommandExecutor) leave);
        this.getCommand("stats").setExecutor((CommandExecutor) stats);
        this.getCommand("kit").setExecutor((CommandExecutor) kit);
        this.getCommand("setup").setExecutor((CommandExecutor) setup);
